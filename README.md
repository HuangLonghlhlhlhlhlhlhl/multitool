...
![版本](https://img.shields.io/badge/版本-1.6.0-orange)
...
1. **下载** [最新 Release](https://github.com/HuangLonghlhlhlhlhlhlhl/multitool/releases/latest) 中的 `STATUS CTRL-v1.6.0.dmg`
...
v1.6.0 引入全新的智能在线升级系统与温度单位标准化重构：
...
## 🏎️ 性能架构与规范性升级 (v1.6.0 重构)

v1.6.0 对底层进行了系统性重构与规范化，彻底消除了卡顿：
