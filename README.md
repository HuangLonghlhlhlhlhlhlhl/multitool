...
![版本](https://img.shields.io/badge/版本-1.9.2-orange)
...
1. **下载** [最新 Release](https://github.com/HuangLonghlhlhlhlhlhlhl/multitool/releases/latest) 中的 `STATUS CTRL-v1.9.2.dmg`
