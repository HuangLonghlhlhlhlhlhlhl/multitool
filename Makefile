...
$(APP_BUNDLE): smchelper KeyboardBacklightPrivate.o main.swift AppDelegate.swift SMCController.swift PowerMonitor.swift DashboardView.swift MemoryPurger.swift Bridging-Header.h
	...
	swiftc \
		...
		PowerMonitor.swift DashboardView.swift MemoryPurger.swift \
